...
export default function Overview() {
  ...
  const lineData = {
    ...
    datasets: [
      { label: "Tasks Completed", data: [2,3,5,4,6,7,completed], borderColor:"#7e22ce", backgroundColor:"rgba(126,34,206,0.2)", tension:0.3 },
      { label: "Tasks Pending", data: [3,2,1,2,1,0,pending], borderColor:"#d946ef", backgroundColor:"rgba(217,70,239,0.2)", tension:0.3 }
    ]
  };
  ...
  return (
    <div className="flex min-h-screen font-[Inter]">
      ...
      <main className="flex-1 p-4 md:p-6 bg-gray-50">
        <h1 className="text-2xl font-bold mb-7 text-purple-700">Overview</h1>
